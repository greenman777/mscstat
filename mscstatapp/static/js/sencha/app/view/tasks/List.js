Ext.define('MSCSTAT.view.tasks.List' ,{
    ...
    viewConfig: {
        getRowClass: function (record, rowIndex, rowParams, store) {
            store_status = Ext.data.StoreManager.lookup('TaskStatus');
    ...
    initComponent: function() {
    	this.store = Ext.create('MSCSTAT.store.Tasks');
        this.columns = [
  			{xtype:'rownumberer',width:30},
        	{
				...
				renderer: function(value, meta, record, rowIndex, colIndex, store, view) {
					store = Ext.data.StoreManager.lookup('Priority');
